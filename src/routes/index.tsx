        ...
        <header className="flex items-center justify-between px-6 lg:px-10 py-5">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden lg:flex items-center gap-6 text-sm text-neutral-700">
              ...
              <Link to="/agent" search={{ p: "" }} className="bg-orange-500 hover:bg-orange-600 text-white rounded-full px-3 py-1 text-sm font-medium flex items-center gap-2 transition">
